        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex" role="search" style="width: 70%">
                ...
                <%
                    ...
                    if(customer == null) {
                %>
                <a href="Customer/login.jsp" class="btn btn-primary" style="white-space: nowrap">
                    Đăng nhập
                </a>
                <%
                    }else {
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 bg-infor ">
                    <li class="nav-item dropdown"><a
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="Customer/ChangeInfo.jsp">Thay đổi thông tin</a></li>
                            <li><a class="dropdown-item" href="Customer/ChangePassword.jsp">Đổi mật khẩu</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="CustomerController?hanhDong=do-logout">Thoát tài khoản</a></li>
                        </ul></li>
                </ul>
                <%
                    }
