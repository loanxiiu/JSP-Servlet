...
//    @GeneratedValue
    ...
    @Column(name = "duongDanAnh", length = 1000)
    ...
    public Customer(String idCustomer, String nameCustomer, Date dateOfBirth, boolean gender, City address, String phoneNumber, String email, Account account, String maXacThuc, Instant thoiGianHieuLucCuaMaXacThuc, Boolean trangThaiXacThuc, String duongDanAnh) {
