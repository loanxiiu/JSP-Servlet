...
<jsp:include page="../header.jsp"/>
        <main class="form-signin w-100 m-auto">
            <form class="text-center" action="<%=url%>/CustomerController" method="post">
                <input type="hidden" name="hanhDong" value="do-login">

                <img class="mb-4" src="http://localhost:8080/JSP_Coffee2_war_exploded/img/coffee.png" alt="" width="72" height="57">
